            ...
            children: [
              ...
              Column(
                children: const [
                  ...
                  ProfileOptionCard(icon: Icons.contrast, title: "Appearance"),
                  ProfileOptionCard(
                    icon: Icons.lock,
...
class ProfileOptionCard extends StatelessWidget {
  ...
  final bool showDivider; // new flag
  ...
  const ProfileOptionCard({
    ...
    required this.title,
    this.onTap,
    this.showDivider = true, // default shows divider
  });
      ...
      children: [
        ...
        if (showDivider)
          Divider(
            ...
            height: 0,
            thickness: 1,
            indent: 16, // gap from left
            endIndent: 16, // gap from right
          ),
      ],
    );
  }
